...
class JoinFilter[In1, In2, Out](private val source1: PullPipe[In1], private val source2: PullPipe[In2], private val operation: (In1, In2) => Optional[Out]) extends MessageProducer[Out] {
