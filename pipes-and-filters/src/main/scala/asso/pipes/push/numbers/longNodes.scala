...
object ProducerConsumerFactory {
  ...
  def consumerToConsole(messageProducer: PushPipe[Long]): EndNode[Long] = new LongConsumer(System.out, messageProducer, AssoValues.DefaultDuration)
...
class LongConsumer(private val printer: PrintStream, private val pipe: PushPipe[Long], duration: Duration) extends EndNode[Long] {
